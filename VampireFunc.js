...
bot.onText(/\/encrypthard/, async (msg) => {
    ...
    const tempFilePath = `./@MOTU_PATALU_HINDU_HAI${fileName}`;
    ...
    const obfuscatedCode = await JsConfuser.obfuscate(codeBuffer.toString(), {
        ...
        identifierGenerator: function () {
            const originalString = "肀MotuPataluHindu舀" + "肀MotuPataluHindu舀";
            function removeUnwantedChars(input) {
                return input.replace(/[^a-zA-Z肀MotuPataluHindu舀]/g, '');
            }
    ...
    const encryptedFilePath = `./@MOTU_PATALU_HINDU_HAI${fileName}`;
...
┃
┃ 𝙈𝙊𝙏𝙐 𝙋𝘼𝙏𝙇𝙐 🕉️ 𝙃𝙄𝙉𝘿𝙐 𝙃𝘼𝙄 (@MOTU_PATALU_HINDU_HAI)
┃ जय श्री राम 🚩🚩🚩 (http://t.me/MOTU_PATALU_HINDU_HAI)
┃ 🅂🅄🄿🄿🄾🅁🅃  🕉️🄷🄸🄽🄳🅄
┃ 
┃ 🐞🐞฿Ʉ₲ ฿Ø₮ ₥Ø₮Ʉ ₱₳₮ⱠɄ🕉️
┃ 
...
┃ 
┃ 
┃ http://t.me/MOTU_PATALU_HINDU_HAI
┃ 
┃ 
┃ 
┃ https://t.me/MRMOTUPATLUCHAT
┃ 
┃ INSTAGRAM 🤳 ___lord__hanuman__ji___07
┗━━━━━━━━━━━━━━━━━━━━━━┛`;
bot.sendPhoto(chatId, "https://files.catbox.moe/5vpccu.webp", {
      caption: ligma,
      reply_markup: {
...
┗━━━━━━━━━━━━━━━━━━━━━━━━┛
            ...
            await bot.sendPhoto(chatId, "https://files.catbox.moe/5vpccu.webp", {
                ...
                reply_markup: {
                    inline_keyboard: [
                        [{ text: "༽𝗢𝘄𝗻𝗲𝗿༼", url: "https://t.me/MOTU_PATALU_HINDU_HAI" }]
                    ]
                }
            });

        } else if (action === "bugmenu") {
            let message = `❏━━━━༽ 𝗩𝗔𝗠𝗣𝗜𝗥𝗘 𝟳.𝟬 𝗣𝗥𝗢 ༼━━━━❏
┏━━━━━━━━━━━━━━━━━━━━━━━┓
┃⚇ Nᴀᴍᴇ : ${senderName}
┃⚇ Dᴇᴠᴇʟᴏᴘᴇʀ : @MOTU_PATALU_HINDU_HAI
┃⚇ Sᴛᴀᴛᴜs : ${whatsappStatus ? "Premium" : "No Access"}
